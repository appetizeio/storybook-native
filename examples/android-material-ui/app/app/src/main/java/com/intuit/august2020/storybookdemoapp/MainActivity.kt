...
class MainActivity : AppCompatActivity() {
    ...
    private fun propagateQueryParams(openIntent: Intent, viewIntent: Intent) {
        openIntent.data?.let { openData ->
            for (param in openData.queryParameterNames) {
                viewIntent.putExtra(param, openData.getQueryParameter(param));
            }
        }
    }
    ...
    private fun handleIntent(intent: Intent) {
        ...
        intent.data?.let { intentData ->
            if (intentData.getQueryParameter("component") != null) {
                component = intentData.getQueryParameter("component")
            }
